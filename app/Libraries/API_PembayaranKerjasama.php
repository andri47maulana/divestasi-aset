...
class API_PembayaranKerjasama
{
    ...
    public function postData($table, $data) {
        ...
        try {
            ...
            $query = $db->table('persetujuanfinal_pembayarankk')
            ->where('persetujuanfinal_pembayarankk_paket_kerjasama_id',  $paket_kerjasama) 
            ->select('SUM(persetujuanfinal_pembayarankk_nominal) as total_sum')
            ->get();
            ...
            $db->table('paket_kerjasama')
               ->set('paket_kerjasama_total_pembayaran', $totalSum)
